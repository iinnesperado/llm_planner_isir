...
#     def calculate_activation(self, percetion=None, activation_list=None):
#         """
#         Calculate the new activation value for a given perception.
#         This activation value might be calculated a little bit differently ???? not sure yet but maybe
